...
function Home() {
  ...
  return (
    <>
      <Box component='div' style={heroStyle}>
        <Container fixed sx={{ mt: "30px", pb: "30px" }}>
          <Grid container direction="row" justifyContent="center" alignItems="center" height='calc(35vh - 10px)'>
          ...
          <Grid container mt={2}>
            <Grid item xs={12} lg={6} md={6} sx={{ display: "flex", flexDirection: "row", justifyContent: "space-around" }}>
